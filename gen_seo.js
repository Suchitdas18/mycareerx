        ...
        <div class="container" style="max-width: 1000px; margin: 0 auto;">
            ...
            <div class="reveal" style="background: var(--surface); padding: 3rem; border-radius: var(--radius-lg); box-shadow: var(--shadow-md); margin-bottom: 3rem;">
                ...
                <p style="font-size: 1.1rem; color: var(--text-muted); line-height: 1.8;">
                    Our certified career experts utilize psychometric analysis mixed with real-world industry feedback to provide an accurate roadmap. Whether you're aiming for top engineering institutes (KIIT, VIT, SRM, LPU, BITS, SOA, etc.) or exploring untraditional avenues, we ensure your future is secure.
                </p>
            </div>
            ...
            <div class="reveal" style="text-align: center; margin-top: 4rem;">
                <h2 style="font-size: 2.5rem; margin-bottom: 1rem;">Ready to Unlock Your Potential?</h2>
